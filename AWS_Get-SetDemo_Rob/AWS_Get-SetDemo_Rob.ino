...
static const char* RANGE_KEY_NAME = "RangeKey";
static const char* RANGE_KEY_VALUE = "1";
static const char* TABLE_NAME = "AWSESP8266";
...
/////////////////////////////////////////////////////////////////
const char* ssid = "Kercem2";                //<<---CHANGE AS NECESSARY
const char* password = "E0E3106433F4";     //<<---CHANGE AS NECESSARY
const IPAddress ipadd(192,168,1,174);          //<<---CHANGE AS NECESSARY    
const IPAddress ipgat(192,168,1,1);            //<<---CHANGE AS NECESSARY      
