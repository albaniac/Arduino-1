...
void publish(const char *topic, int data1) {
  ...
  iotClient.setAWSPath("/things/Room_Temp_2/shadow");
  ...
  //insert a negative sign in the published string if required  
//  String attribute_string ="";
//  if (data1 < 0) {
//    attribute_string = ("{\"state\":{\"reported\":{\"Temperature\":-");
//  }
//  else {
//    attribute_string = ("{\"state\":{\"reported\":{\"Temperature\":");
//  }
//
//  MinimalString shadow = (attribute_string + String(data1, DEC) + "}}}").c_str();
